...
if __name__ == "__main__":
    ...
    cities = input(dedent("""What are your cities of interest?"""))
    date_range = input(dedent("""What are your preferred dates?"""))
    interests = input(dedent("""What are some of your interests during travel?"""))

    trip_crew = TripCrew(origin, cities, date_range, interests)
    result = trip_crew.run()
    print("\n\n########################")
    print("## Here are your run results:")
    print("########################\n")
    print(result)
